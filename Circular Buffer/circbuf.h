...
static inline CB_Enum_t circbuf_full(CircBuf_t *circ) __attribute__((always_inline));
...
static inline CB_Enum_t circbuf_empty(CircBuf_t *circ) __attribute__((always_inline));
